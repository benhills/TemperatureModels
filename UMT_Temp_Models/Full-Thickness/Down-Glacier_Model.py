...
### save data to the desired file

np.savetxt('Down-Glacier_Results/control_high.txt',out_high)
np.savetxt('Down-Glacier_Results/control_low.txt',out_low)
np.savetxt('Down-Glacier_Results/control_mid.txt',out_mid)
#np.savetxt('Down-Glacier_Results/step_high.txt',out_high)
#np.savetxt('Down-Glacier_Results/step_low.txt',out_low)
#np.savetxt('Down-Glacier_Results/step_mid.txt',out_mid)
#np.savetxt('Down-Glacier_Results/control_no_vel.txt',out_mid)
#np.savetxt('Down-Glacier_Results/Strain_A_%s.txt' %24.,out_mid)
#np.savetxt('Down-Glacier_Results/Strain_n_%s.txt' %Strain_n,out_mid)
#np.savetxt('Down-Glacier_Results/LatentTop.txt',out_mid)
#np.savetxt('Down-Glacier_Results/LatentBoth.txt',out_mid)

#np.savetxt('Down-Glacier_Results/Foliation.txt',np.append([Tout_high],[Tout_low],axis=0))

#np.savetxt('Down-Glacier_Results/Depths.txt',depth_out)
